/* hashset.c generated by valac 0.36.11, the Vala compiler
...
GeeHashSet* gee_hash_set_construct (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeeHashDataFunc hash_func, void* hash_func_target, GDestroyNotify hash_func_target_destroy_notify, GeeEqualDataFunc equal_func, void* equal_func_target, GDestroyNotify equal_func_target_destroy_notify) {
	...
	GeeFunctionsHashDataFuncClosure* _tmp9_;
	...
	hash_func_target = NULL;
	hash_func_target_destroy_notify = NULL;
	_tmp9_ = gee_functions_hash_data_func_closure_new (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp8_, _tmp8__target, _tmp8__target_destroy_notify);
	...
	equal_func_target = NULL;
	equal_func_target_destroy_notify = NULL;
	_tmp11_ = gee_functions_equal_data_func_closure_new (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp10_, _tmp10__target, _tmp10__target_destroy_notify);
...
static GeeHashSetIterator* gee_hash_set_iterator_construct_from_iterator (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeeHashSetIterator* iter) {
	...
	GeeHashSet* _tmp1_;
	GeeHashSet* _tmp2_;
	GeeHashSetIterator* _tmp3_;
	gint _tmp4_;
	GeeHashSetIterator* _tmp5_;
	GeeHashSetNode* _tmp6_;
	GeeHashSetIterator* _tmp7_;
	GeeHashSetNode* _tmp8_;
		...
		_tmp7_ = _tmp5_[0];
		{
			...
			i = (guint) 1;
			{
				...
				while (TRUE) {
					...
					_tmp13_ = gee_hash_set_iterator_new_from_iterator (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, (GDestroyNotify) self->priv->g_destroy_func, self);
...
static void gee_hash_set_iterator_class_init (GeeHashSetIteratorClass * klass) {
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), GEE_HASH_SET_ITERATOR_READ_ONLY_PROPERTY, g_param_spec_boolean ("read-only", "read-only", "read-only", FALSE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	g_object_class_install_property (G_OBJECT_CLASS (klass), GEE_HASH_SET_ITERATOR_VALID_PROPERTY, g_param_spec_boolean ("valid", "valid", "valid", FALSE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
}
...
static void gee_hash_set_class_init (GeeHashSetClass * klass) {
	...
	((GeeAbstractCollectionClass *) klass)->foreach = (gboolean (*) (GeeAbstractCollection *, GeeForallFunc, void*)) gee_hash_set_real_foreach;
	 ...
	 * {@inheritDoc}
	 */
	g_object_class_install_property (G_OBJECT_CLASS (klass), GEE_HASH_SET_SIZE_PROPERTY, g_param_spec_int ("size", "size", "size", G_MININT, G_MAXINT, 0, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	/**
	 * {@inheritDoc}
	 */
	g_object_class_install_property (G_OBJECT_CLASS (klass), GEE_HASH_SET_READ_ONLY_PROPERTY, g_param_spec_boolean ("read-only", "read-only", "read-only", FALSE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
}
