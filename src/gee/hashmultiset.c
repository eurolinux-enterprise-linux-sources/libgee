/* hashmultiset.c generated by valac 0.36.11, the Vala compiler
...
GeeHashMultiSet* gee_hash_multi_set_construct_broken (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeeHashDataFunc hash_func, void* hash_func_target, GeeEqualDataFunc equal_func, void* equal_func_target) G_GNUC_DEPRECATED;
...
GeeHashMultiSet* gee_hash_multi_set_construct_broken (GType object_type, GType g_type, GBoxedCopyFunc g_dup_func, GDestroyNotify g_destroy_func, GeeHashDataFunc hash_func, void* hash_func_target, GeeEqualDataFunc equal_func, void* equal_func_target) {
	...
	_tmp1_ = equal_func;
	_tmp1__target = equal_func_target;
	_tmp2_ = gee_hash_map_new (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, G_TYPE_INT, NULL, NULL, _tmp0_, _tmp0__target, NULL, _tmp1_, _tmp1__target, NULL, NULL, NULL, NULL);
	_tmp3_ = _tmp2_;
	self = (GeeHashMultiSet*) gee_abstract_multi_set_construct (object_type, g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, (GeeMap*) _tmp3_);
	self->priv->g_type = g_type;
	self->priv->g_dup_func = g_dup_func;
