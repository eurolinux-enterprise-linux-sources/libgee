/* unfolditerator.c generated by valac 0.36.11, the Vala compiler
...
static gboolean gee_unfold_iterator_real_foreach (GeeTraversable* base, GeeForallFunc f, void* f_target) {
	...
	while (TRUE) {
		GeeUnfoldFunc _tmp26_;
		void* _tmp26__target;
		GeeLazy* _tmp27_;
		GeeLazy* _tmp28_;
		GeeLazy* _tmp29_;
		GeeForallFunc _tmp30_;
		void* _tmp30__target;
		GeeLazy* _tmp31_;
...
static void gee_unfold_iterator_class_init (GeeUnfoldIteratorClass * klass) {
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), GEE_UNFOLD_ITERATOR_VALID_PROPERTY, g_param_spec_boolean ("valid", "valid", "valid", FALSE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	g_object_class_install_property (G_OBJECT_CLASS (klass), GEE_UNFOLD_ITERATOR_READ_ONLY_PROPERTY, g_param_spec_boolean ("read-only", "read-only", "read-only", FALSE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
}
