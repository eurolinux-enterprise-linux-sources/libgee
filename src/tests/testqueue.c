/* testqueue.c generated by valac 0.36.11, the Vala compiler
...
void queue_tests_test_one_element_operation (QueueTests* self) {
	...
	_tmp26_ = gee_abstract_collection_get_size ((GeeAbstractCollection*) recipient);
	_tmp27_ = _tmp26_;
	...
	_tmp35_ = gee_abstract_collection_get_size ((GeeAbstractCollection*) recipient);
	_tmp36_ = _tmp35_;
	...
	_tmp43_ = gee_abstract_collection_get_size ((GeeAbstractCollection*) recipient);
	_tmp44_ = _tmp43_;
